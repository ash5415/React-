...
function GraphiQL(_a) {
    ...
    return (react_1.default.createElement(react_2.GraphiQLProvider, { getDefaultFieldNames: getDefaultFieldNames, dangerouslyAssumeSchemaIsValid: dangerouslyAssumeSchemaIsValid, defaultQuery: defaultQuery, defaultHeaders: defaultHeaders, defaultTabs: defaultTabs, externalFragments: externalFragments, fetcher: fetcher, headers: headers, initialTabs: initialTabs, inputValueDeprecation: inputValueDeprecation, introspectionQueryName: introspectionQueryName, maxHistoryLength: maxHistoryLength, onEditOperationName: onEditOperationName, onSchemaChange: onSchemaChange, onTabChange: onTabChange, onTogglePluginVisibility: onTogglePluginVisibility, plugins: plugins, visiblePlugin: visiblePlugin, operationName: operationName, query: query, response: response, schema: schema, schemaDescription: schemaDescription, shouldPersistHeaders: shouldPersistHeaders, storage: storage, validationRules: validationRules, variables: variables },
        react_1.default.createElement(GraphiQLInterface, __assign({ showPersistHeadersSettings: shouldPersistHeaders !== false }, props))));
}
...
function GraphiQLInterface(props) {
    ...
    return (react_1.default.createElement("div", { "data-testid": "graphiql-container", className: "graphiql-container" },
        react_1.default.createElement("div", { className: "graphiql-sidebar" },
            react_1.default.createElement("div", { className: "graphiql-sidebar-section" }, pluginContext === null || pluginContext === void 0 ? void 0 : pluginContext.plugins.map(function (plugin) {
        ...
        react_1.default.createElement("div", { className: "graphiql-main" },
            ...
            react_1.default.createElement("div", { ref: pluginResize.secondRef, style: { minWidth: 0 } },
        ...
        react_1.default.createElement(react_2.Dialog, { isOpen: showDialog === 'settings', onDismiss: function () {
            ...
            props.showPersistHeadersSettings ? (react_1.default.createElement("div", { className: "graphiql-dialog-section" },
                ...
                react_1.default.createElement(react_2.ButtonGroup, null,
                    react_1.default.createElement(react_2.Button, { type: "button", id: "enable-persist-headers", className: editorContext.shouldPersistHeaders ? 'active' : undefined, onClick: function () {
                            editorContext.setShouldPersistHeaders(true);
                        } }, "On"),
                    react_1.default.createElement(react_2.Button, { type: "button", id: "disable-persist-headers", className: editorContext.shouldPersistHeaders ? undefined : 'active', onClick: function () {
