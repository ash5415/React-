...
export function GraphiQLInterface(props) {
    ...
    return (React.createElement("div", { "data-testid": "graphiql-container", className: "graphiql-container" },
        React.createElement("div", { className: "graphiql-sidebar" },
            React.createElement("div", { className: "graphiql-sidebar-section" }, pluginContext === null || pluginContext === void 0 ? void 0 : pluginContext.plugins.map(function (plugin) {
        ...
        React.createElement(Dialog, { isOpen: showDialog === 'settings', onDismiss: function () {
            ...
            props.showPersistHeadersSettings ? (React.createElement("div", { className: "graphiql-dialog-section" },
                ...
                React.createElement(ButtonGroup, null,
                    React.createElement(Button, { type: "button", id: "enable-persist-headers", className: editorContext.shouldPersistHeaders ? 'active' : undefined, onClick: function () {
                            editorContext.setShouldPersistHeaders(true);
                        } }, "On"),
                    React.createElement(Button, { type: "button", id: "disable-persist-headers", className: editorContext.shouldPersistHeaders ? undefined : 'active', onClick: function () {
