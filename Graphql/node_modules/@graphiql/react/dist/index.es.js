...
import { createContext as createContext$1, useContext, useRef, useState, useEffect, forwardRef, useLayoutEffect, useCallback, createElement, PureComponent, useId as useId$1, useMemo, Fragment, memo, useReducer, Children, cloneElement } from "react";
...
var Listbox$1 = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name(function Listbox(_ref2, forwardedRef) {
  ...
  return /* @__PURE__ */ createElement(ListboxInput, _extends$4({}, props2, {
    ...
    return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement(ListboxButton$1, {
      arrow,
...
var Menu$1 = /* @__PURE__ */ forwardRef(function(_ref2, forwardedRef) {
  var _ref$as = _ref2.as, Comp = _ref$as === void 0 ? Fragment : _ref$as, id2 = _ref2.id, children = _ref2.children, rest = _objectWithoutPropertiesLoose$2(_ref2, _excluded$2);
...
var Tooltip = /* @__PURE__ */ forwardRef(function(_ref2, forwardedRef) {
  ...
  return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ cloneElement(child, trigger), /* @__PURE__ */ createElement(TooltipPopup, _extends$1({
    ref: forwardedRef,
    label,
...
var TooltipContent = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name(function TooltipContent2(_ref4, forwardedRef) {
  ...
  return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement(Comp, _extends$1({
...
function HistoryItem(props2) {
  ...
  return /* @__PURE__ */ jsx("li", {
    ...
    children: isEditable ? /* @__PURE__ */ jsxs(Fragment$1, {
...
function SchemaDocumentation(props2) {
  ...
  const typeMap = props2.schema.getTypeMap();
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, {
    children: [/* @__PURE__ */ jsx(MarkdownContent, {
      ...
      children: typeMap && /* @__PURE__ */ jsx("div", {
        children: Object.values(typeMap).map((type2) => {
          if (ignoreTypesInAllSchema.includes(type2.name) || type2.name.startsWith("__")) {
            return null;
          }
...
function Field$1(props2) {
  return /* @__PURE__ */ jsxs(Fragment$1, {
    ...
    }), props2.argument ? /* @__PURE__ */ jsxs(Fragment$1, {
      children: ["(", /* @__PURE__ */ jsx("span", {
...
function TypeDocumentation(props2) {
  return isNamedType(props2.type) ? /* @__PURE__ */ jsxs(Fragment$1, {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxs("div", {
      children: [/* @__PURE__ */ jsx(FieldLink, {
        field
      }), args.length > 0 ? /* @__PURE__ */ jsxs(Fragment$1, {
        children: ["(", /* @__PURE__ */ jsx("span", {
  ...
  void importCodeMirror([], { useCommonAddons: false }).then((CodeMirror) => {
    ...
    CodeMirror.on(data, "select", (ctx, el2) => {
      if (!information) {
        ...
        deprecation.append(deprecationReason2);
  ...
  useEffect(() => {
    ...
    void importCodeMirror([
      ...
      newEditor.on("keyup", (editorInstance, event) => {
        ...
        const isLetter2 = keyCode >= 65 && keyCode <= 90;
        const isNumber = keyCode >= 48 && keyCode <= 57;
        if (isLetter2 || !shiftKey && isNumber || key === "_" || key === '"') {
